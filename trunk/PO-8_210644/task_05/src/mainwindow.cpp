    ...
    , ui(new Ui::MainWindow)
{
    ...
    selectSellersButton = new QPushButton("sellers table");
    selectProductButton = new QPushButton("product table");
    findSellerByProductIdButton = new QPushButton("find seller by product id");
    countTotalSumForEachSellerButton = new QPushButton("count total sum for each seller");
