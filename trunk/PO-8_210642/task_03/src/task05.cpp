...
{
    // Получаем имена из каждого класса
    ...
    // Определяем общие имена для всех классов
    QStringList commonNames;
    QSet<QString> uniqueNames;

    // Обрабатываем класс 1
    ...
    // Определяем уникальные имена для каждого класса
